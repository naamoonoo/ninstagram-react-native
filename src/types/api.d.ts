...
export interface GetFeeds_GetFeeds_feeds_comments_user {
	__typename: "User";
	id: string;
	firstName: string;
	profilePhoto: string;
...
export interface GetFeeds_GetFeeds_feeds_comments {
	__typename: "Comment";
	id: string;
	comment: string | null;
	user: GetFeeds_GetFeeds_feeds_comments_user | null;
}
...
export interface GetFeeds_GetFeeds_feeds {
	...
	updateAt: string;
	comments: (GetFeeds_GetFeeds_feeds_comments | null)[] | null;
}
